...
import { TmdbMovieDetails, RegisterMoviePayload, calculateOverall, todayISO, getPosterUrl, formatRating, formatDate } from '../types';
          ...
          {otherViewInfo?.otherView && (
            <div className="bg-secondary/10 border border-secondary/30 rounded-xl p-3 text-sm">
              ...
              <span className="text-muted">
                {' '}
                · ★ {formatRating(otherViewInfo.otherView.overall_rating)} · {formatDate(otherViewInfo.otherView.watched_at)}
              </span>
            </div>
          )}
